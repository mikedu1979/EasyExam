	...
	public partial class IssuNews : System.Web.UI.Page
	{
		...
		protected void ButInput_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				this.RegisterStartupScript("newWindow","<script language='javascript'>alert('发布通知成功！');try{ window.opener.RefreshForm() }catch(e){};</script>");
			}
			catch
			{
				ObjTran.Rollback();
				this.RegisterStartupScript("newWindow","<script language='javascript'>alert('发布通知失败！')</script>");
			}
			finally
			{
				ObjConn.Close();
