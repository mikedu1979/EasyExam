						...
						<table style="BORDER-COLLAPSE: collapse" borderColor="#6699ff" height="336" cellSpacing="0"
							...
							<tr>
								<td style="COLOR: #990000" align="center" background="bg_dh_middle.gif" bgColor="#ffffff"
									height="24" colspan="2"><font style="FONT-SIZE: 16px" face="黑体" color="#ffffff">发布通知</font></td>
							</tr>
							<TR>
								<TD style="WIDTH: 74px; HEIGHT: 23px" align="right">通知标题：</TD>
							...
							<TR>
								<td style="WIDTH: 74px; HEIGHT: 219px" align="right">通知内容：</td>
