							...
							<TBODY>
								<tr>
									<td style="COLOR: #990000" align="center" background="../Images/bg_dh_middle.gif" bgColor="#ffffff"
										height="24"><font style="FONT-SIZE: 16px" face="黑体" color="#ffffff">通知管理</font></td>
								</tr>
								<tr>
									<td style="HEIGHT: 22px">&nbsp;&nbsp;通知标题：<asp:textbox id="txtNewsTitle" runat="server" CssClass="text" Width="247px"></asp:textbox>
									...
									<td vAlign="top" align="center"><asp:datagrid id="DataGridNews" runat="server" Width="100%" AllowSorting="True" PageSize="15"
											...
											<Columns>
												...
												<asp:TemplateColumn SortExpression="NewsTitle" HeaderText="通知标题">
													<ItemTemplate>
														<asp:Label id="labNewsTitle" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"NewsTitle") %>'>通知标题</asp:Label>
													</ItemTemplate>
												</asp:TemplateColumn>
