						...
						<table cellSpacing="0" cellPadding="1" width="100%" align="center" border="0" style="LINE-HEIGHT: 200%">
							<tr>
								...
								<td vAlign="bottom" align="right" width="20%">
                                    <asp:Button class="lenButton" ID="btnRedo" runat="server" Text="错题重做" 
                                        Enabled="False" onclick="btnRedo_Click" />&nbsp;
                                    <INPUT class="lenButton" onclick="jscomExportTableToWord('tblPaper')" type="button" value="导出到Word">&nbsp;<INPUT class="button" onclick="window.print();" type="button" value="打 印"></td>
							</tr>
						</table>
					</td>
				</tr>
