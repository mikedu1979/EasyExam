...
<HTML>
	...
	TD { FONT-SIZE: 9pt; COLOR: #333333; LINE-HEIGHT: 150% }
	.sec_menu { BORDER-RIGHT: white 1px solid; BACKGROUND: #ffffff; OVERFLOW: hidden; BORDER-LEFT: white 1px solid; BORDER-BOTTOM: white 1px solid }
	...
	A:link {
	COLOR: #003399; TEXT-DECORATION: none; TEXT-TRANSFORM: none
}
A:visited {
	COLOR: #003399; TEXT-DECORATION: none; TEXT-TRANSFORM: none
}
A:hover {
	...
	<body onselectstart="return false" bottomMargin="0" bgColor="#e6f4fa" leftMargin="0" topMargin="0"
		rightMargin="0">
			...
			<tr>
				<td id="frmTitle" vAlign="top" noWrap align="center" width="135">
					...
					<script language="javascript">
                        ...
                        top.document.title ="理论学习与考试系统 V1.1"; 
                    </script>
				</td>
