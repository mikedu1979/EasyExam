	...
	public partial class MainLeftMenu : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (intUserType==0)//普通帐户
			{
				...
				strMainMenu=strMainMenu+"<span style='font-weight: bold; left: 36px; color: #215dc6; position: relative; top: 2px'>个人业务</span></td>";
				strMainMenu=strMainMenu+"</tr>";
				strMainMenu=strMainMenu+"<tr>";
				...
				strMainMenu=strMainMenu+"<tr>";
				strMainMenu=strMainMenu+"<td style='font-size: 9pt; color: #333333; line-height: 150%' width='100'><a target='main' href='PersonInfo/BrowNewsList.aspx'><font color='000000'>查看通知</font></a></td>";
				strMainMenu=strMainMenu+"</tr>";
				strMainMenu=strMainMenu+"<tr>";
				...
				strMainMenu=strMainMenu+"</tr>";
				 strMainMenu = strMainMenu + "<tr>";
                strMainMenu = strMainMenu + "<td style='font-size: 9pt; color: #333333; line-height: 150%' width='100'><a target='main' href='PersonInfo/ErrBook.aspx'><font color='000000'>错题卡</font></a></td>";
                strMainMenu = strMainMenu + "</tr>";
			...
			else//管理帐户
			{
				...
				strMainMenu=strMainMenu+"height='25'>";
				strMainMenu=strMainMenu+"<span style='font-weight: bold; left: 36px; color: #215dc6; position: relative; top: 2px'>个人中心</span></td>";
				strMainMenu=strMainMenu+"</tr>";
				strMainMenu=strMainMenu+"<tr>";
				...
				if ((intRoleMenu==1)||(ObjFun.GetValues("select OptionID from UserPower where UserID="+intUserID+" and PowerID=3 and OptionID=1","OptionID")!=""))//通知管理
				{
					strMainMenu=strMainMenu+"<tr>";
					...
					strMainMenu=strMainMenu+"align='center'>";
					strMainMenu=strMainMenu+"<tr>";
					strMainMenu=strMainMenu+"<td style='font-size: 9pt; color: #333333; line-height: 150%'><a target='main' href='NewsManag/ManagNewsList.aspx'><font color='000000'>通知管理</font></a></td>";
					strMainMenu=strMainMenu+"</tr>";
					strMainMenu=strMainMenu+"</table>";
					strMainMenu=strMainMenu+"</div>";
					strMainMenu=strMainMenu+"</td>";
