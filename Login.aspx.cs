...
namespace EasyExam
{
    ...
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            if (!IsPostBack)
            {
                DateTime dt = DateTime.ParseExact("20211231080000", "yyyyMMddhhmmss", System.Globalization.CultureInfo.CurrentCulture);
                if (DateTime.Now > dt)
                {
                    Response.Write("<script>alert('系统过期，请及时更新')</script>");
        ...
        //public static void IsProcessTimeOut()
        //{
